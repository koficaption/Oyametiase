# Architecture — Church of Pentecost, Oyame Tiase Assembly

This document describes the production architecture for the **Oyame Tiase Assembly Management System**. It is a **single local assembly** system. The Presiding Elder is the highest local authority. Multi-branch church administration is intentionally not implemented.
...
The Church of Pentecost
 └── Oyame Tiase Assembly          ← this software instance
