...
describe("weekly collection sheet UI", () => {
  it("names the week and keeps Sunday school on Sunday only", async () => {
    ...
    expect(weekName).toHaveAttribute("placeholder", "Last supper week");
    await user.type(weekName, "Last supper week");
    expect(screen.getByText("Last supper week")).toBeInTheDocument();
